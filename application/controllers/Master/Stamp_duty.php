...
class Stamp_duty extends CI_Controller {
    ...
    public function index() {
        ...
        $data['data_set'] = $this->Db_model->getData('ID,Name,IsActive,isFixed', 'tbl_stamp_duty');
        $this->load->view('Master/Stamp_duty/index', $data);
    }
    ...
    public function insert_data() {
        ...
        $data = array(
            'Name' => $this->input->post('txt_allowance'),
            'IsActive' => 1,
            'isFixed' => $Fixed
                
        );

        $result = $this->Db_model->insertData("tbl_stamp_duty", $data);
        ...
        redirect(base_url() . 'Master/Stamp_duty/'); //*********Redirect to designation form
