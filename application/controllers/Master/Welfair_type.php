...
class Welfair_type extends CI_Controller {
    ...
    public function index() {
        ...
        $data['data_set'] = $this->Db_model->getData('ID,Welfair_name,IsActive,isFixed', 'tbl_welfair');
        $this->load->view('Master/Welfair/index', $data);
    }
    ...
    public function insert_data() {
        ...
        $data = array(
            'Welfair_name' => $this->input->post('txt_allowance'),
            'IsActive' => 1,
            'isFixed' => $Fixed
                
        );

        $result = $this->Db_model->insertData("tbl_welfair", $data);
        ...
        redirect(base_url() . 'Master/Welfair_type/'); //*********Redirect to designation form
