...
.background span:nth-child(29) {
  ...
  <body class="focused-form" style=" background: url(<?php echo base_url(); ?>assets/images/company/header-left.svg) left top no-repeat, linear-gradient(to bottom, rgb(241 90 47) 0%, rgb(141 197 68 / 94%) 100%);
          background-size: 83%;
        ...
        <div class="container" id="login-form" >
            <a class="login-logo"><h3 style="color: black;">
                ...
                <img style="width: 350px; height: 122px;" src="<?php base_url(); ?>
                          ...
                          echo "assets/images/company/janrich_logo-6-1-2.png"
  ...
  box-shadow: 1px 3px 5px 5px #ffccff;">
                        <div class="panel-heading "><h2 style="color: #0079c4"><img style="width: 40px;" src="<?php echo base_url(); ?>assets/images/company/VTF-Logo.png">&nbsp;&nbsp;&nbsp;Login To Payroll System</h2></div>
