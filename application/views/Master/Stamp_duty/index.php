                        ...
                        <div class="page-content">
                            ...
                            <div class="page-tabs">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li><a data-toggle="tab" href="#tab2">VIEW STAMP DUTY</a></li>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="panel panel-info">
                                                            <div class="panel-heading"><h2>ADD STAMP DUTY </h2></div>
                                                            <div class="panel-body">
                                                                <form class="form-horizontal" id="frm_allowance_types" name="frm_allowance_types" action="<?php echo base_url(); ?>Master/Stamp_duty/insert_data" method="POST">
                                                                    ...
                                                                    <div class="form-group col-sm-6">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <input type="text" class="form-control" id="txt_allowance" name="txt_allowance" placeholder="Ex: STAMP DUTY">
                                                                        </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h2 class="modal-title">STAMP DUTY</h2>
                                            </div>
                                            <div class="modal-body">
                                                <form class="form-horizontal" action="<?php echo base_url(); ?>Master/Holiday_Types/edit" method="post">
                                                    ...
                                                    <div class="form-group col-sm-12">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input value="<?php echo $data->Name; ?>" type="text" name="H_Code" id="H_Code"  class="form-control m-wrap span6"><br>
                                                        </div>
                                                    </div>
