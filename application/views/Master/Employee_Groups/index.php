                                                                ...
                                                                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        foreach ($data_set as $data) {
                                                                            ...
                                                                            echo "<td width='100'>" . $data->GracePeriod . "</td>";
                                                                            echo "<td width='100'>" . $data->NosLeaveForMonth . "</td>";
                                                                            echo "<td width='100'>" . $data->MaxSLS . "</td>";
                                                                            echo "<td width='100'>" . $data->Allow1stSession . "</td>";
                                                                            echo "<td width='100'>" . $data->Allow2ndSession . "</td>";
//                                                                            echo "<td width='100'>" . $data->OTPattern . "</td>";

                                                                            echo "<td width='15'>";
                                                                            echo "<button class='get_data btn btn-green'  data-toggle='modal' data-target='#myModal' title='EDIT' data-id='$data->Grp_ID' href='" . base_url() . "index.php/Master/Department/get_details" . $data->Grp_ID . "'><i class='fa fa-edit'></i></button>";
                                                                            echo "</td>";
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h2 class="modal-title">EMPLOYEE GROUP</h2>
                                            </div>
                                            <div class="modal-body">
                                                <form class="form-horizontal" action="<?php echo base_url(); ?>Master/Designation/edit" method="post">
                                                    <div class="form-group col-sm-12">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input value="<?php echo $data->Grp_ID; ?>" type="text" class="form-control" readonly="readonly" name="id" id="id" class="m-wrap span3" >
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-sm-12">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input value="<?php echo $data->EmpGroupName; ?>" type="text" name="Desig_Name" id="Desig_Name"  class="form-control m-wrap span6"><br>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-sm-12">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input value="<?php echo $data->GracePeriod; ?>" type="text" name="Desig_Order" id="Desig_Order"  class="form-control m-wrap span6"><br>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-sm-12">
                                                        <label for="focusedinput" class="col-sm-4 control-label">ORDER</label>
                                                        <div class="col-sm-8">
                                                            <input value="<?php echo $data->NosLeaveForMonth; ?>" type="text" name="Desig_Order" id="Desig_Order"  class="form-control m-wrap span6"><br>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-sm-12">
                                                        <label for="focusedinput" class="col-sm-4 control-label">ORDER</label>
                                                        <div class="col-sm-8">
                                                            <input value="<?php echo $data->MaxSLS; ?>" type="text" name="Desig_Order" id="Desig_Order"  class="form-control m-wrap span6"><br>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-sm-12">
                                                        <label for="focusedinput" class="col-sm-4 control-label">ORDER</label>
                                                        <div class="col-sm-8">
                                                            <input value="<?php echo $data->Allow1stSession; ?>" type="text" name="Desig_Order" id="Desig_Order"  class="form-control m-wrap span6"><br>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-sm-12">
                                                        <label for="focusedinput" class="col-sm-4 control-label">ORDER</label>
                                                        <div class="col-sm-8">
                                                            <input value="<?php echo $data->Allow2ndSession; ?>" type="text" name="Desig_Order" id="Desig_Order"  class="form-control m-wrap span6"><br>
                                                        </div>
                                                    </div>
