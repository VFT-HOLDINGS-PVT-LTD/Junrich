...
$html = '
        <div style="margin-left:200px; text-align:center; font-size:13px;">IN OUT REPORT ROW</div>
            ...
            <table cellpadding="3">
                <thead style="border-bottom: #000 solid 1px;">
                    <tr style="border-bottom: 1px solid black;"> 
                        ...
                        <th style="font-size:11px;border-bottom: 1px solid black; width:100px;">WH</th>         
                    </tr>
                </thead>
             <tbody>';
...
foreach ($data_set as $data) {
    ...
    $html .= ' <tr>
                        ...
                        <td style="font-size:10px;">' . $data->WorkHour . '</td>
                    </tr>'
