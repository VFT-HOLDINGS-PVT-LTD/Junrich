                                                    ...
                                                    <div style="" class="panel ">
                                                        ...
                                                        <div class="panel-body">
                                                            <form action="<?php echo base_url(); ?>index.php/Attendance/Attendance_Process_New/emp_attendance_process" class="form-horizontal" id="frmBackup" name="frmBackup" method="POST">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-8 col-sm-offset-2">
                                                                        <button type="submit" id="submit" name="submit" class="btn-success btn-lg fa fa-check">&nbsp;&nbsp;ATTENDANCE OFFICE PROCESS</button>
                                                            ...
                                                            <form action="<?php echo base_url(); ?>index.php/Attendance/Attendance_Process/emp_attendance_process" class="form-horizontal" id="frmBackup" name="frmBackup" method="POST">
                                                                <div class="row">
                                                                    <div class="col-sm-8 col-sm-offset-2">
                                                                        <button type="submit" id="submit1" name="submit1" class="btn-success btn-lg fa fa-check">&nbsp;&nbsp;ATTENDANCE SOYAMEAT PROCESS</button>
                                                                        <!--<button type="button" id="Cancel" name="Cancel" class="btn btn-danger-alt fa fa-times-circle">&nbsp;&nbsp;CANCEL</button>-->
                                                                    </div>
                                                                </div>
                                                            </form>
