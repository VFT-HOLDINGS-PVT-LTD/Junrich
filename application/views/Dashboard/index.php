                                ...
                                <div data-widget-group="group1">
                                    <div class="row">
                                        ...
                                        <?php if ($currentUser[0]->add_employee == 1): ?>
                                            <div  class="col-md-3" >
                                                <a style="background-color: #3a869f" class="info-tile has-footer" href="<?php echo base_url(); ?>Employee_Management/ADD_Employees">
                                                    ...
                                                    <div class="tile-footer" style="background: rgb(34,96,129);
background: linear-gradient(60deg, rgba(34,96,129,1) 0%, rgba(57,106,129,0.644782913165266) 100%);">
                                        ...
                                        <?php if ($currentUser[0]->shift_allocation == 1): ?>
                                            <div class="col-md-3">
                                                <a style="background-color: #3a869f" class="info-tile has-footer" href="<?php echo base_url(); ?>Attendance/Shift_Allocation">
...
background: linear-gradient(60deg, rgba(34,96,129,1) 0%, rgba(57,106,129,0.644782913165266) 100%);" class="tile-footer">
                                        ...
                                        <?php if ($currentUser[0]->attendance_process == 1): ?>
                                            <div class="col-md-3">
                                                <a style="background-color: #3a869f" class="info-tile has-footer" href="<?php echo base_url(); ?>Attendance/Attendance_Process_test">
                                                    <div class="tile-heading">
...
background: linear-gradient(60deg, rgba(34,96,129,1) 0%, rgba(57,106,129,0.644782913165266) 100%);" class="tile-footer">
                                        ...
                                        <?php if ($currentUser[0]->payroll_process == 1): ?>
                                            <div class="col-md-3">
                                                <a style="background-color: #3a869f" class="info-tile has-footer" href="<?php echo base_url(); ?>Pay/Payroll_Process/">
                                                    <div class="tile-heading">
...
background: linear-gradient(60deg, rgba(34,96,129,1) 0%, rgba(57,106,129,0.644782913165266) 100%);" class="tile-footer">
                                    ...
                                    <div class="row">
                                        <?php if ($currentUser[0]->leave_request == 1): ?>
                                            ...
                                            <div class="col-md-3">
                                                <a style="background-color: #3a869f" class="info-tile has-footer" href="<?php echo base_url(); ?>Leave_Transaction/Leave_Request">
                                                    <div class="tile-heading">
...
background: linear-gradient(60deg, rgba(34,96,129,1) 0%, rgba(57,106,129,0.644782913165266) 100%);" class="tile-footer">
                                        ...
                                        <?php if ($currentUser[0]->manual_att_request == 1): ?>
                                            ...
                                            <div class="col-md-3">
                                                <a style="background-color: #3a869f" class="info-tile has-footer" href="<?php echo base_url(); ?>Attendance/Attendance_Manual_Entry_Request">
                                                    <div class="tile-heading">
...
background: linear-gradient(60deg, rgba(34,96,129,1) 0%, rgba(57,106,129,0.644782913165266) 100%);" class="tile-footer">
                                        ...
                                        <?php if ($currentUser[0]->leave_approve == 1): ?>
                                            <div class="col-md-3">
                                                <a style="background-color: #3a869f" class="info-tile has-footer" href="<?php echo base_url(); ?>Leave_Transaction/Leave_Approve">
                                                    <div class="tile-heading">
...
background: linear-gradient(60deg, rgba(34,96,129,1) 0%, rgba(57,106,129,0.644782913165266) 100%);" class="tile-footer">
                                        ...
                                        <?php if ($currentUser[0]->request_advance == 1): ?>
                                            <div class="col-md-3">
                                                <a style="background-color: #3a869f" class="info-tile has-footer" href="<?php echo base_url(); ?>Pay/Salary_Advance_req/">
                                                    <div class="tile-heading">
